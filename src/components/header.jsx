// import {ReactComponent as Logo} from '../assets/resume-icon.svg' 
function Header(){
    return(
        <>
        <header>
            <Logo/>
            <h1 className="page-title">build your resume here!</h1>
